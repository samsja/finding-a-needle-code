...
def get_data_cifar_10(path_data, N, limit_search=None):
    ...
    with open("thesis_data_search/pickles/cifar_10/eval.pkl", "rb") as f:
        list_eval = pickle.load(f)

    with open("thesis_data_search/pickles/cifar_10/test.pkl", "rb") as f:
        list_test = pickle.load(f)

    with open("thesis_data_search/pickles/cifar_10/label_list.pkl", "rb") as f:
        label_list = pickle.load(f)
